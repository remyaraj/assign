 ...
 *
 * wrong way of implementation but just to chk the number of threads............
 * 
 */
...
{
	int pid,sockfd,portno,n, k=0,i,j;
	...
	while(1){
		...
		n = pthread_create(t_arr,0,commun,(void *)sockfd);
		if(n){
